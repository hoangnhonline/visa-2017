...
class BaoKimPayment 
{
	...
	// Mã merchante site 
	private $merchant_id = '31086';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = '392a222caeb6b1bd'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
